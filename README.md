...
|------------|------------------------------------------------------|
| Zhanserik  | Архитектура, GraphQL API, модели/сервисы, CI scripts |
| Tim (demo) | Next.js UI, Zustand/Apollo, realtime UX, README      |

(*Если проект защищается двумя студентами — заполните таблицу своими именами и зонами ответственности.*)
